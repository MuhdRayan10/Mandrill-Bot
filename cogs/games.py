...
class wheel:
    def __init__(self) -> None:
        ...
        self.items_ = ['1,111 $LEF - Native coin of the "Wild Network"', 'Mineral', 'NFT Comics Series "Chronicles of the Ten unique Flowers"',
                       '"Wild Network" Branded Merch & Physical Artwork (First Edition)', 'Try Again in 7 Days',]
